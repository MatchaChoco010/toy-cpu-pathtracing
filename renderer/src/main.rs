...
fn main() {
    ...
    match args.scene {
        ...
        6 => scene::load_scene_6(&mut scene, &mut camera),
        7 => scene::load_scene_7(&mut scene, &mut camera),
        8 => scene::load_scene_8(&mut scene, &mut camera),
        9 => scene::load_scene_9(&mut scene, &mut camera),
        10 => scene::load_scene_10(&mut scene, &mut camera),
        11 => scene::load_scene_11(&mut scene, &mut camera),
        12 => scene::load_scene_12(&mut scene, &mut camera),
        13 => scene::load_scene_13(&mut scene, &mut camera),
        14 => scene::load_scene_14(&mut scene, &mut camera),
        15 => scene::load_scene_15(&mut scene, &mut camera),
        16 => scene::load_scene_16(&mut scene, &mut camera),
        17 => scene::load_scene_17(&mut scene, &mut camera),
        18 => scene::load_scene_18(&mut scene, &mut camera),
        19 => scene::load_scene_19(&mut scene, &mut camera),
